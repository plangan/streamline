...
using Researcher.API.Infrastructure.Filters;
using StreamLineModels;
using System;
using System.Data.Common;
using System.Text;

namespace Researcher.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwagger()
              .UseSwaggerUI(c => c.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "Researcher.API V1"));
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "StreamLine - Researcher HTTP API",
                    Version = "v1",
                    Description = "The Researcher Microservice HTTP API.",
